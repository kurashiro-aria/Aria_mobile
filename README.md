...
- Desde 0.2.32 los recuerdos explícitos tienen categorías derivadas del texto guardado, fecha y contador de uso, con lectura compatible de datos anteriores. Una nueva orden de recordar un hecho inequívocamente equivalente (por ejemplo, un nombre o gusto corregido) actualiza el recuerdo existente; la recuperación no presenta a la vez dos versiones de ese hecho. Los datos relativos a «hoy» o «ayer» dejan de aparecer automáticamente pasadas 48 horas, pero siguen visibles para que Kura pueda corregirlos u olvidarlos. ARIA introduce recuerdos pertinentes como hechos, sin recitar números de registro ni afirmar una vida humana.
- En 0.2.32.1 Identity Core conserva la identidad de ARIA, mientras ExpressionStyle guarda por separado una forma temporal de hablar: natural, juguetona, provocadora, irónica suave, cariñosa, tímida, seria, concentrada, entusiasmada, reconfortante o coqueta. Kura puede pedir estos matices con lenguaje normal y cancelarlos; una situación seria los interrumpe. Personality Engine entrega al GGUF una instrucción breve, sin respuestas prefabricadas ni números de intensidad. El retrato puede acompañar el estilo; la voz queda para una fase futura.
