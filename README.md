...
- La personalidad de ARIA se carga con el GGUF. Cuando el mensaje continúa el hilo, recibe hasta cuatro mensajes recientes; también puede recibir hasta tres recuerdos explícitos relacionados y fragmentos anteriores del usuario relacionados. El mensaje actual va al final. Un saludo o tema nuevo no arrastra la conversación anterior.
